...
吸附能计算公式：**E_ads = E_combined - E_surface - E_molecule**
...
详细的能量计算方法请参考：`各种能量计算.md`

### 态密度及能带计算

详细的DOS和能带计算方法请参考：`态密度及能带计算.md`

### NEB过渡态搜索

详细的NEB计算方法请参考：`NEB过渡态搜索.md`

### 差分电荷密度分析

详细的CDD分析方法请参考：`差分电荷密度分析CDD.md`

### 结构构建

详细的结构构建方法请参考：`结构构建.md`

### 作业提交后检查

详细的检查方法请参考：`作业提交后检查方法.md`

### KPOINTS生成

详细的KPOINTS生成方法请参考：`KPOINTS生成方法.md`

### 常见问题解答

详细的常见问题及解决方案请参考：`常见问题汇总.md`
...
VASPKIT是一个强大的VASP前后处理工具，详细使用方法请参考：
- `VASPKIT.md` - 基础使用指南
- `VASPKIT中文手册.pdf` - 完整手册

### VASP脚本工具

VTSTscripts工具集提供了丰富的VASP计算脚本，详细说明请参考：`VASP脚本工具总结.md`

### VASP-GREP工具

用于快速提取VASP计算结果的grep命令合集，详细说明请参考：`VASP-GREP.md`